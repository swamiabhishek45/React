...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-full py-10 pb-28 bg-black">
      <div
      ...
      >
        ...
        <p className="mt-2 text-center text-base text-white/60">
          ...
          <Link
            to="/signup"
            className="font-medium text-purple-400 text-primary transition-all duration-200 hover:underline"
          >
            Sign Up
          </Link>
        </p>
